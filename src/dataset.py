...
class TumorDataset(Dataset):
    ...
    def __init__(self, root_dir, image_size=1024):
        ...
        self.default_transformation = v2.Compose([
            v2.RandomCrop(size=image_size, antialias=True),
    ...
    def __getitem__(self, index):
        ...
        input_image_name = os.path.join(self.root_dir, str(index)+'_mip.png')
        output_image_name = os.path.join(self.root_dir, str(index)+'_edof.png')
